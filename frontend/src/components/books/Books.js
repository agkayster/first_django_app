            ...
            <div className='comedy'>
              <label className='checkbox'>
                <input
                  type='checkbox'
                  checked={
                    this.state.checkBoxState['comedy'] || ''
                  }
            ...
            <div className='Fiction'>
              <label className='checkbox'>
                <input
                  type='checkbox'
                  checked={
                    this.state.checkBoxState['fiction'] ||
										''
                  }
                  onChange={this.handleSort}
                  value='fiction'
            ...
            <div className='Horror'>
              <label className='checkbox'>
                <input
                  type='checkbox'
                  checked={
                    this.state.checkBoxState['horror'] || ''
                  }
                  onChange={this.handleSort}
                  value='horror'
                />
            ...
            <div className='Thriller'>
              <label className='checkbox'>
                <input
                  type='checkbox'
                  checked={
                    this.state.checkBoxState['thriller'] ||
										''
                  }
                  onChange={this.handleSort}
                  value='thriller'
            ...
            <div className='Romance'>
              <label className='checkbox'>
                <input
                  type='checkbox'
                  checked={
                    this.state.checkBoxState['romance'] ||
										''
                  }
                  onChange={this.handleSort}
                  value='romance'
            ...
            <div className='Sci-fi'>
              <label className='checkbox'>
                <input
                  type='checkbox'
                  checked={
                    this.state.checkBoxState['sci-fi'] || ''
                  }
                  onChange={this.handleSort}
                  value='sci-fi'
                />
            ...
            <div className='Action'>
              <label className='checkbox'>
                <input
                  type='checkbox'
                  checked={
                    this.state.checkBoxState['action'] || ''
                  }
                  onChange={this.handleSort}
                  value='action'
                />
            ...
            <div className='priceZero'>
              <label className='checkbox'>
                <input
                  ...
                  name='0-1.99'
                  checked={
                    this.state.checkBoxState['0-1.99'] || ''
                  }
                  onChange={(e) =>
                    this.handleSortPrice(e, {
                      priceMax: 1.99,
                      priceMin: 0
                    })
                  }
            ...
            <div className='priceOne'>
              <label className='checkbox'>
                <input
                  ...
                  name='2-2.99'
                  checked={
                    this.state.checkBoxState['2-2.99'] || ''
                  }
                  onChange={(e) =>
                    this.handleSortPrice(e, {
                      priceMax: 2.99,
            ...
            <div className='priceTwo'>
              <label className='checkbox'>
                <input
                  ...
                  name='3-3.99'
                  checked={
                    this.state.checkBoxState['3-3.99'] || ''
                  }
                  onChange={(e) =>
                    this.handleSortPrice(e, {
                      priceMax: 3.99,
            ...
            <div className='priceThree'>
              <label className='checkbox'>
                <input
                  type='checkbox'
                  checked={
                    this.state.checkBoxState['4 - 4.99'] ||
										''
                  }
                  onChange={this.handleSort}
                  value='4 - 4.99'
            ...
            <div className='priceFour'>
              <label className='checkbox'>
                <input
                  type='checkbox'
                  checked={
                    this.state.checkBoxState['5 - 5.99'] ||
										''
                  }
                  onChange={this.handleSort}
                  value='5 - 5.99'
